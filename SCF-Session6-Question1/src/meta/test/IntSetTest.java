...
public class IntSetTest {
	...
	*/
	...
	assertArrayEquals(expectedArray, intSet.getIntArray((intSet.getCompliment(intSet).getIntSet())));
	}
	...
	*/
	...
	assertArrayEquals(new int[] { 1, 3, 5, 8, 12, 15, 18, 40, 2, 4, 7 }, obj1.getIntArray(obj1.union(obj1, obj2).getIntSet()));
